...
서울과학기술대학교 2학년, AI/ML 엔지니어를 준비하고 있습니다.

## About
- 서울과학기술대학교 2학년
- 2026년 140명 규모 AI 동아리 **A.ING** 회장
- 창업동아리 팀 **EAO** 대표

## Build & Leadership
- A.ING 공식 사이트 제작 및 배포: https://aing.uk
- EAO 프로젝트 (Xinote) 제작 및 배포: https://xinote.ai
...
| 2026 | 서울시립대 공개 AI 경진대회 (Track1) | **2등 / 1,652명** (CNN + Transformer Dual-Tower) | [Solution](https://github.com/sehunkuim/uos-soccer-dual-tower-solution) |
...
## Reference Links
- LG Aimers 대회 페이지: https://dacon.io/competitions/official/236673/overview/description
- 국민대 리더보드: https://dacon.io/competitions/official/236619/leaderboard
- DACON 메인: https://dacon.io/

---
대회별 상세 실험과 산출물은 각 솔루션 레포에서 확인할 수 있습니다.
